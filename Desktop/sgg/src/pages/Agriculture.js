...
const Agriculture = () => {
  ...
  // Fetch the documents related to "Agriculture et Pêche" from the backend
  useEffect(() => {
    const themeName = encodeURIComponent('Agriculture et Pêche');
  ...
  return (
    <div className="container mx-auto my-8 p-4">
      <h2 className="text-3xl font-bold text-center mb-8">Documents pour Agriculture et Pêche</h2>
